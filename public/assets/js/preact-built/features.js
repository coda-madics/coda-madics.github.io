(() => {
  ...
  // ns-hugo-imp:/Users/je/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/kit/modules/blox@v0.0.0-20260219145709-764756ab501c/blox/features/component.jsx
  ...
  function FeatureItem({ item, iconSvg }) {
    return /* @__PURE__ */ u2("div", { children: [
      iconSvg && /* @__PURE__ */ u2("div", { class: "flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-primary-100 lg:h-14 lg:w-14 dark:bg-primary-900 text-primary-600 dark:text-primary-300", children: /* @__PURE__ */ u2(Icon, { svg: iconSvg, attributes: { class: "flex items-center justify-center w-6 h-6 lg:w-8 lg:h-8" } }) }),
      item.name && /* @__PURE__ */ u2("h3", { class: "mb-2 text-xl font-bold dark:text-white", dangerouslySetInnerHTML: { __html: renderText(item.name) } }),
      item.description && /* @__PURE__ */ u2("p", { class: "text-gray-500 dark:text-gray-400", dangerouslySetInnerHTML: { __html: renderText(item.description) } })
    ] });
  }
  var FeaturesBlock = ({ content, _design, _id, icon_svgs }) => {
    const title = content?.title;
    const text = content?.text;
    const items = Array.isArray(content?.items) ? content.items : [];
    const iconMap = icon_svgs || {};
    return /* @__PURE__ */ u2("section", { children: /* @__PURE__ */ u2("div", { class: "py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6", children: [
      (title || text) && /* @__PURE__ */ u2("div", { class: "max-w-screen-md mb-8 lg:mb-16 flex flex-col justify-center mx-auto", children: [
        title && /* @__PURE__ */ u2(
          "h2",
          {
      ...
      /* @__PURE__ */ u2("div", { class: "space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0", children: items.map((item, idx) => /* @__PURE__ */ u2(FeatureItem, { item, iconSvg: item.icon ? iconMap[item.icon] : null }, idx)) })
    ] }) });
  };
    ...
    blocks.forEach((block) => {
      ...
      if (propsData) {
        try {
          ...
          J(/* @__PURE__ */ u2(FeaturesBlock, { ...props }), block);
