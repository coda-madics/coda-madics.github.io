(() => {
  ...
  // ns-hugo-imp:/Users/je/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/kit/modules/blox@v0.0.0-20260219145709-764756ab501c/blox/cta-image-paragraph/component.jsx
  function renderText(text) {
    if (!text) return "";
    return String(text).replace(/\*\*(.*?)\*\*/g, "<strong>$1</strong>").replace(/\*(.*?)\*/g, "<em>$1</em>").replace(/`(.*?)`/g, "<code>$1</code>").replace(/\[([^\]]+)\]\(([^)]+)\)/g, '<a href="$2">$1</a>');
  }
  var ArrowIcon = () => /* @__PURE__ */ u2("svg", { "aria-hidden": "true", class: "ml-2 -mr-1 w-5 h-5", fill: "currentColor", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ u2(
    "path",
    {
      "fill-rule": "evenodd",
  ...
  function CtaItem({ item, idx, imageData, featureIconSvg }) {
    ...
    return /* @__PURE__ */ u2("div", { class: `gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 ${hasImage ? "md:grid md:grid-cols-2" : ""} sm:py-16 lg:px-6`, children: [
      hasImage && (imageData.srcset ? /* @__PURE__ */ u2(
        "img",
        {
          class: "w-full",
          ...
          alt: item.title || "",
          style: isReversed ? { order: 1 } : void 0
        }
      ) : /* @__PURE__ */ u2(
        "img",
        {
      ...
      /* @__PURE__ */ u2("div", { class: "mt-4 md:mt-0", children: [
        item.title && /* @__PURE__ */ u2(
          "h2",
          {
        ...
        item.text && /* @__PURE__ */ u2("p", { class: "mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400", dangerouslySetInnerHTML: { __html: renderText(item.text) } }),
        features.length > 0 && /* @__PURE__ */ u2("ul", { children: features.map((feature, fIdx) => /* @__PURE__ */ u2("li", { class: "relative mb-4 pl-6", children: [
          featureIconSvg ? /* @__PURE__ */ u2(Icon, { svg: featureIconSvg, attributes: { class: "inline-block pr-5", style: "height: 1em;" } }) : null,
          /* @__PURE__ */ u2("span", { dangerouslySetInnerHTML: { __html: renderText(String(feature)) } })
        ] }, fIdx)) }),
        item.button?.text && item.button?.url && /* @__PURE__ */ u2(
          "a",
          {
            href: buttonUrl,
  ...
  var CtaImageParagraphBlock = ({ content, _design, _id, item_images, icon_svgs }) => {
    const items = Array.isArray(content?.items) ? content.items : [];
    const imageMap = item_images || {};
    const iconMap = icon_svgs || {};
    return /* @__PURE__ */ u2("div", { children: items.map((item, idx) => /* @__PURE__ */ u2(
      CtaItem,
      {
        item,
        idx,
    ...
    blocks.forEach((block) => {
      ...
      if (propsData) {
        try {
          ...
          J(/* @__PURE__ */ u2(CtaImageParagraphBlock, { ...props }), block);
