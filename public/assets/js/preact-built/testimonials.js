(() => {
  ...
  // ns-hugo-imp:/Users/je/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/kit/modules/blox@v0.0.0-20260219145709-764756ab501c/blox/testimonials/component.jsx
  var QuoteSvg = () => /* @__PURE__ */ u2(
    "svg",
    {
      "aria-hidden": "true",
      ...
      fill: "currentColor",
      viewBox: "0 0 32 32",
      children: /* @__PURE__ */ u2("path", { d: "M9.563 8.469l-0.813-1.25c-5.625 3.781-8.75 8.375-8.75 12.156 0 3.656 2.688 5.375 4.969 5.375 2.875 0 4.906-2.438 4.906-5 0-2.156-1.375-4-3.219-4.688-0.531-0.188-1.031-0.344-1.031-1.25 0-1.156 0.844-2.875 3.938-5.344zM21.969 8.469l-0.813-1.25c-5.563 3.781-8.75 8.375-8.75 12.156 0 3.656 2.75 5.375 5.031 5.375 2.906 0 4.969-2.438 4.969-5 0-2.156-1.406-4-3.313-4.688-0.531-0.188-1-0.344-1-1.25 0-1.156 0.875-2.875 3.875-5.344z" })
    }
  );
  ...
  function TestimonialItem({ item, avatarUrl, isLast }) {
    return /* @__PURE__ */ u2("div", { class: `max-w-screen-md mx-auto ${isLast ? "" : "mb-12"}`, children: [
      /* @__PURE__ */ u2(QuoteSvg, {}),
      /* @__PURE__ */ u2("blockquote", { children: /* @__PURE__ */ u2("p", { class: "text-2xl font-medium text-gray-900 dark:text-white", dangerouslySetInnerHTML: { __html: `"${renderText(item.text)}"` } }) }),
      /* @__PURE__ */ u2("div", { class: "flex items-center justify-center mt-6 space-x-3", children: [
        avatarUrl ? /* @__PURE__ */ u2("img", { class: "w-12 h-12 rounded-full", src: avatarUrl, width: "48", height: "48", alt: item.name || "", loading: "lazy" }) : /* @__PURE__ */ u2("div", { class: "w-12 h-12 rounded-full bg-gray-200 dark:bg-gray-700" }),
        /* @__PURE__ */ u2("div", { class: "flex flex-col items-center", children: [
          item.name && /* @__PURE__ */ u2("div", { class: "pr-3 font-medium text-gray-900 dark:text-white", children: item.name }),
          item.role && /* @__PURE__ */ u2("div", { class: "pl-3 text-sm font-light text-gray-500 dark:text-gray-400", children: item.role })
        ] })
      ] })
    ] });
  }
  var TestimonialsBlock = ({ content, _design, _id, item_images }) => {
    const title = content?.title;
    const text = content?.text;
    const items = Array.isArray(content?.items) ? content.items : [];
    const imageMap = item_images || {};
    return /* @__PURE__ */ u2("section", { children: /* @__PURE__ */ u2("div", { class: "max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6", children: [
      title && /* @__PURE__ */ u2("div", { class: "py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6", children: /* @__PURE__ */ u2("div", { class: "max-w-screen-md mb-8 lg:mb-16 flex flex-col justify-center mx-auto", children: [
        /* @__PURE__ */ u2(
          "h2",
          {
        ...
        text && /* @__PURE__ */ u2("p", { class: "text-gray-500 sm:text-xl dark:text-gray-400 text-center", dangerouslySetInnerHTML: { __html: renderText(text) } })
      ] }) }),
      items.map((item, idx) => /* @__PURE__ */ u2(TestimonialItem, { item, avatarUrl: imageMap[String(idx)]?.src || null, isLast: idx === items.length - 1 }, idx))
    ] }) });
  };
    ...
    blocks.forEach((block) => {
      ...
      if (propsData) {
        try {
          ...
          J(/* @__PURE__ */ u2(TestimonialsBlock, { ...props }), block);
